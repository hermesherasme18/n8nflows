...
# Esto permite conservar la información de nón (flujos, credenciales, etc.) fuera del contenedor
VOLUME /data
# Expone el puerto 8080, que es donde nón se ejecuta por defecto
EXPOSE 8080|
